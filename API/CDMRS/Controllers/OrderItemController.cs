...
namespace API.CDMRS.Controllers
{
    ...
    public class OrderItemController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(OrderItemModel))]
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(OrderItemModel orderItem)
        {
            try
            {
                if (orderItem == null)
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] OrderItemModel orderItem)
        {
            try
            {
