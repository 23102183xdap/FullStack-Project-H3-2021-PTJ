...
namespace API.CDMRS.Controllers
{
    ...
    public class DeliveryController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(DeliveryModel))]
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(DeliveryModel delivery)
        {
            try
            {
                if (delivery == null)
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] DeliveryModel delivery)
        {
            try
            {
